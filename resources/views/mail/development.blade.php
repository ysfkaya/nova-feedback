...
<head>
    ...
    <title>{{ trans('nova-feedback::resources.development_request') }}</title>
                                                ...
                                                <table width="100%" border="0" align="center" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top"
                                                            ...
                                                            {{ trans('nova-feedback::resources.development_request') }}
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="middle" bgcolor="#f5f5f5"
                                                                        ...
                                                                        <table width="250" border="0" align="center"
                                                                            ...
                                                                            <tr>
                                                                                <th>{{ trans('nova-feedback::developments.subject') }}
                                                                                    :
                                                                                </th>
                                                            ...
                                                            <table width="155" border="0" align="center" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td height="50" align="center" valign="middle"
                                                                        bgcolor="#fe573c">
                                                                        <a href="{{ url(config('nova.path').'/resources/developments/'.$development->id) }}"
